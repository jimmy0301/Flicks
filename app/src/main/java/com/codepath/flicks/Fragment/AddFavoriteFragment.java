...
public class AddFavoriteFragment extends DialogFragment {
   ...
   public static AddFavoriteFragment newInstance(Movie movieItem) {
   ...
   public Dialog onCreateDialog(Bundle savedInstanceState) {
      ...
      String message = "Are you sure to add the movie " + "\"" + movieTitle + "\" to favorite" + "?";
      ...
      alertDialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
         ...
         public void onClick(DialogInterface dialog, int which) {
            ...
            favoriteMovie.insert();

            dialog.dismiss();
            Toast toast = Toast.makeText(getContext(), "\"" + movieTitle + "\"" + "add to favorite successfully", Toast.LENGTH_LONG);
            toast.show();
